...
echo "build.sh: [1/3] swift-bundler bundle"
...
echo "build.sh: [2/3] install AppIcon.icns into bundle"
...
echo "build.sh: [3/3] re-sign bundle (ad-hoc, deep) + install to /Applications"
